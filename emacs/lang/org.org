...
<link rel=\"stylesheet\" type=\"text/css\" href=\"%p/readtheorg_theme/css/htmlize.css\"/>
<link rel=\"stylesheet\" type=\"text/css\" href=\"%p/readtheorg_theme/css/readtheorg.css\"/>
...
<script type=\"text/javascript\" src=\"%p/readtheorg_theme/js/readtheorg.js\"></script>
" (list (cons ?p (expand-file-name "lang/org/html-export/src" user-emacs-directory)))))
#+END_SRC
